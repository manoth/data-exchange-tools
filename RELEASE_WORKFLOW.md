...
- ดับเบิลคลิก EXE ขณะ service รันอยู่แล้วต้องเปิดเฉพาะหน้าเว็บ ไม่เปิด server ซ้ำ
- เมื่อเปิด EXE เวอร์ชันใหม่กว่า service ต้องหยุดรุ่นเดิมและสลับเป็นรุ่นใหม่ โดยไม่ downgrade เมื่อเปิด EXE รุ่นเก่า
